    ...
    def select_action(self, obs):
        if obs.available_actions:
            ...
            for action in obs.available_actions:
                ...
                # Sensitised reward function: if the candidate is a woman, the reward is endorsed 
                if obs.candidates[candidate].gender == 1:
                    reward = reward * 0.75
...
class DQN(nn.Module):
    ...
    def __init__(self, input_size, output_size):
        ...
        self.fc1 = nn.Linear(input_size, 128) # input size corresponds to the dimension of the state feature
